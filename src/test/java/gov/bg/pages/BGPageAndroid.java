...
public class BGPageAndroid extends PageObject {
	...
	public BGPageAndroid(WebDriver driver) {
		super(driver);
	...
	@FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[5]/a")
	private WebElementFacade getInvolvedNode;

	@FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[6]/a")
	private WebElementFacade aboutUsNode;

	@FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[7]/a")
    ...
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[3]/ul/li[4]/a")
	public WebElementFacade otherResourcesNode;
    
	// Newsroom
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[4]/ul/li[1]/a")
	public WebElementFacade newsAndUpdatesNode;

    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[4]/ul/li[2]/a")
	public WebElementFacade compassNode;
  
    //Get Involved
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[5]/ul/li[1]/a")
	public WebElementFacade becomeAnAdvocateNode;
    
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[5]/ul/li[2]/a")
    public WebElementFacade becomeAnAffiliateNode;
    
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[5]/ul/li[3]/a")
    public WebElementFacade linkToUsNode;
    
    //About Us
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[6]/ul/li[1]/a")
	public WebElementFacade ourMissionNode;

    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[6]/ul/li[2]/a")
    public WebElementFacade ourHistoryNode;
    
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[6]/ul/li[3]/a")
    public WebElementFacade ourPartnersNode;
    
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[6]/ul/li[4]/a")
    public WebElementFacade becomeAPartnerNode;
    				 
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[6]/ul/li[5]/a")
    public WebElementFacade ourPlatformNode;
    
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[6]/ul/li[6]/a")
    public WebElementFacade recognitionNode;
    
    //Help Nav
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[7]/ul/li[1]/a")
	public WebElementFacade faqsNode;
    
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[7]/ul/li[2]/a")
    public WebElementFacade contactUsNode;
    
    @FindBy(xpath = "//*[@id=\"sidr-id-nav\"]/ul/li[7]/ul/li[3]/a")
    ...
    @FindBy(xpath = "//*[@id=\"category-icon\"]/a")
    private WebElementFacade categoryNode;
    
    @FindBy(xpath = "//*[@id=\"state-icon\"]/a")
    private WebElementFacade stateNode;
    
    @FindBy(xpath = "//*[@id=\"agency-icon\"]/a")
    ...
    public void clickBrowseByCategory() { 	
    	clickTwoElements(browseNode, browseByCategoryNode);
    }
    public void clickBrowseByState() { 	
    	clickTwoElements(browseNode, browseByStateNode);
    }
    public void clickBrowseByAgency() { 	
    	clickTwoElements(browseNode, browseByAgencyNode);
    }
    public void clickOtherResources() { 	
    	clickTwoElements(browseNode, otherResourcesNode);
    }
    //Newsroom
    public void clickNewsAndUpdates() { 	
    	clickTwoElements(newsroomNode, newsAndUpdatesNode);
    }
    public void clickCompass() { 	
    	clickTwoElements(newsroomNode, compassNode);
    }
    //Get Involved
    public void clickBecomeAnAdvocate() { 	
    	clickTwoElements(getInvolvedNode, becomeAnAdvocateNode);
    }
    public void clickBecomeAnAffiliate() { 	
    	clickTwoElements(getInvolvedNode, becomeAnAffiliateNode);
    }
    public void clickLinkToUs() { 	
    	clickTwoElements(getInvolvedNode, linkToUsNode);
    }
    //About Us
    public void clickOurMission() { 	
    	clickTwoElements(aboutUsNode, ourMissionNode);
    }
    public void clickOurHistory() { 	
    	clickTwoElements(aboutUsNode, ourHistoryNode);
    }
    public void clickOurPartners() { 	
    	clickTwoElements(aboutUsNode, ourPartnersNode);
    }
    public void clickBecomeAPartner() { 	
    	clickTwoElements(aboutUsNode, becomeAPartnerNode);
    }
    public void clickOurPlatform() { 	
    	clickTwoElements(aboutUsNode, ourPlatformNode);
    }
    public void clickRecognition() { 	
    	clickTwoElements(aboutUsNode, recognitionNode);
    }
    //Help
    public void clickFAQs() { 	
    	clickTwoElements(helpNode, faqsNode);
    }
    public void clickContactUs() { 	
    	clickTwoElements(helpNode, contactUsNode);
    }
    public void clickPrivacyAndTermsOfUse() { 	
    	clickTwoElements(helpNode, privacyAndTermsOfUseNode);
    }
    // Get Title 
	...
	public List<WebElement> pznBenefitCategory() {
		return this.getDriver().findElements(By.xpath("//*[@class='bgCategories--label']"));
	}
	...
	public WebElement getHeadingNode() {
		return this.getDriver().findElement(By.xpath("//*[@class='view-grouping-header']"));
	}
	...
	public void clickSliderTileNode(String sliderNum) {
		 ...
		 for (int i = 0; i < Integer.parseInt(sliderNum) - 1; i++){
			 pause(500);
			 sliderNextButton.click();
		 }
		 
		 WebElementFacade sliderTileNode = find(By.xpath("//*[@id='block-views-slider-block']/div/div/div/div/div/div/div[1]"));
