...
import gov.gl.UserGLAndroid;

public class DailyRegressionGLAndroid {

    @Steps
    UserGLAndroid userGL;
    ...
    public void when_the_user_clicks_on_the_GovLoans_toggle_language_button_es() {
		userGL.clickToggleLanguageES();
	}
    
    @When("the user clicks on the GovLoans toggle language button EN(android)")
    public void when_the_user_clicks_on_the_GovLoans_toggle_language_button_en() {
		userGL.clickToggleLanguageEN();
	}
