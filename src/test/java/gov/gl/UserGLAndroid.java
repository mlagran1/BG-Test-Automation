...
import gov.gl.pages.GLPageAndroid;
import gov.gl.pages.GLHomepageAndroid;
...
public class UserGLAndroid {

	GLPageAndroid glPage;
	GLHomepageAndroid glHomepage;
    ...
    public void clickNavNode(String node) {
		...
		case "Buscador de Préstamos": 
			glPage.clickTwoElements(glHomepage.loansMainNavButton, glHomepage.loanFinderSubNavButton);
			break;	
		case "Browse By Category": 
		case "Búsqueda por Categoría": 
			glPage.clickTwoElements(glHomepage.loansMainNavButton, glHomepage.browseByCategorySubNavButton);
			break;	
		case "Other Resources": 
		case "Otros Recursos": 
			glPage.clickTwoElements(glHomepage.loansMainNavButton, glHomepage.otherResourcesSubNavButton);
			break;	
		case "Overview": 
		case "Visión General": 
			glPage.clickTwoElements(glHomepage.aboutMainNavButton, glHomepage.overviewSubNavButton);
			break;	
		case "Link To GovLoans.gov": 
		case "Vínculo a GovLoans.gov": 
			glPage.clickTwoElements(glHomepage.aboutMainNavButton, glHomepage.linkToGovloansSubNavButton);
			break;	
		case "FAQs": 
		case "Preguntas más frecuentes": 
			glPage.clickTwoElements(glHomepage.helpMainNavButton, glHomepage.FAQSubNavButton);
			break;	
		case "Contact Us": 
		case "Contáctenos": 
			glPage.clickTwoElements(glHomepage.helpMainNavButton, glHomepage.contactUsSubNavButton);
			break;	
		case "Glossary": 
		case "Glosario": 
			glPage.clickTwoElements(glHomepage.helpMainNavButton, glHomepage.glossarySubNavButton);
			break;	
		case "Privacy & Terms of Use": 
		case "Privacidad y Términos de Uso": 
			glPage.clickTwoElements(glHomepage.helpMainNavButton, glHomepage.privacyAndTermsSubNavButton);
			break;
		case "Home Nav":
		case "Home Nav ES":
			glPage.pause(1000);
	...
	public void shouldSeePage(String expectedPageName) {
    		String pageTitle = "";
    		if (!expectedPageName.equals("Home Nav") || !expectedPageName.equals("Home Nav ES")) {
  
    			pageTitle = glPage.pullPageTitle();
    		}
	...
	public void verifyHomepageES() {
    	Assert.assertEquals("Bienvenido a GovLoans.gov", glPage.pullSpanishHomepageTitle());
  	}	
    
    
    @Step
	public void clickToggleLanguageES() {
    	glHomepage.languageToggleButton.click();
    	glPage.pause(1000);
    	glHomepage.languageToggleButtonES.click();
  	}
    
    @Step
	public void clickToggleLanguageEN() {
    	glHomepage.languageToggleButton.click();
    	glPage.pause(1000);
    	glHomepage.languageToggleButtonEN.click();
  	}
