...
public class GLHomepageAndroid extends PageObject {
    
	// *************************************************************************
	
	//Main Nav
	@FindBy(xpath = "//*[@id=\"navbar\"]/div/div/a[1]")
	...
	@FindBy(xpath = "//*[@id=\"block-block-2\"]/div/div/div[2]/ul/li[2]/a")
	public WebElementFacade contactUsFooterLink;
	                 
	@FindBy(xpath = " //*[@id=\"block-block-2\"]/div/div/div[2]/ul/li[1]/a")
	public WebElementFacade privacyAndTermsFooterLink;
	
	@FindBy(xpath = "//*[@id=\"U.S. Department of Labor || U.S. Department of Labor\"]/img")
	public WebElementFacade BGFooterLink;
	@FindBy(xpath = "(//*[@id='Other || Other']/img)[1]")
	public WebElementFacade USAGovFooterLink;
	
	@FindBy(xpath = "(//*[@id='Other || Other']/img)[2]")
	...
	@FindBy(xpath = "//*[@id=\"block-locale-language\"]/div[2]/a/i")
	public WebElementFacade languageToggleButton;
	
	@FindBy(xpath = "//*[@id=\"block-locale-language\"]/div[2]/ul/li[1]/a")
	public WebElementFacade languageToggleButtonEN;
	
	@FindBy(xpath = "//*[@id=\"block-locale-language\"]/div[2]/ul/li[2]/a")
